...
import AddDifferentialForm from '../differential/AddDifferentialForm';
import SelectDifferentialForm from '../differential/SelectDifferentialForm';

const NewTextSubProcedure = ({ caseId }) => {
